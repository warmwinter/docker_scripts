...
$CMD run --detach --interactive --name $IMAGEREPO-$IMAGETAG --privileged --publish 127.0.0.1:5600:9000 --restart unless-stopped --tty --volume /web/wwwroot:/web/wwwroot:rw --volume /web/docker/logs/php56:/var/log/php-fpm:rw $IMAGEREPO:$IMAGETAG  
