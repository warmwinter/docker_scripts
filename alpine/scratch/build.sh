...
$CMD run --detach --interactive --name $IMAGEREPO-$IMAGETAG --privileged --publish 127.0.0.1:${FPMPORT}:9000 --restart unless-stopped --tty --volume /web/wwwroot:/web/wwwroot:rw --volume /web/docker/logs/php_master:/var/log/php-fpm:rw $IMAGEREPO:$IMAGETAG  
